...
if( isset($_POST['Email']) )
{
    ...
    //Registreren:
    $sql="INSERT INTO leerling(`ID`, `FirstName`, `LastName`, `Leerjaar`, `Email`, `Password`) VALUES (UUID(),'".$FirstName."','".$LastName."','".$Leerjaar."','".$Email."','".HASH("SHA512",$Password)."')";
...
<form action="registration_lln.php" method="post">
